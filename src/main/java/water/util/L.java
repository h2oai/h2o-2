...
abstract public class L {
  ...
  private static final String HOST_AND_PID =  "" + fixedLength(HOST + " ", 13) + fixedLength(PID + " ", 6);
	...
	static public Throwable err(Object _this, Sys t, String msg, Throwable exception) {
    Event e = new Event(_this,t, Kind.ERRR,exception,new Object[]{msg});
    System.out.println(e.toString());
		return exception;
	}

	static public Throwable warn(Object _this, Sys t, String msg, Throwable exception) {
