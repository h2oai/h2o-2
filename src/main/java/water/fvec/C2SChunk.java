...
public class C2SChunk extends Chunk {
  ...
  @Override public long   get ( int    i ) { return (long)((UDP.get2(_mem,(i<<1)+OFF)+_bias)*_scale); }
  @Override public double getd( int    i ) { return       ((UDP.get2(_mem,(i<<1)+OFF)+_bias)*_scale); }
