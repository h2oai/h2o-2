...
public class C8DChunk extends Chunk {
  ...
  @Override public long   at8_impl( int i ) { double res = UDP.get8d(_mem,i<<3); return Double.isNaN(res)?NA():(long)res;}
  @Override public double atd_impl( int i ) { return       UDP.get8d(_mem,i<<3); }
