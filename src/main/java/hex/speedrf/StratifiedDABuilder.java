package hex.speedrf;//package hex.speedrf;
//
//import hex.speedrf.DRF.DRFTask;
//import hex.speedrf.MinorityClasses.UnbalancedClass;
...
//      _modelDataMap = rf.colMap(ary.colNames());
//    }
...
//    final Frame fr = DKV.get(_drf._rfmodel._dataKey).get();
////    int   row_size        = ary.rowSize();
////    int   rpc             = (int)ValueArray.CHUNK_SZ/row_size;
//    final Vec classCol = _drf._rfmodel.get_response(); // ary._cols[_drf._params._classcol];
//    final int    nclasses = _drf._rfmodel.classes();
//    boolean []   unbalancedClasses = null;
//    final int[] modelDataMap = _drf._rfmodel.colMap(fr._names);
//
