...
public class DTree extends Iced {
  ...
  public static abstract class TreeModel extends water.Model {
    ...
    public TreeModel(TreeModel prior, double err, ConfusionMatrix cm, AUC validAUC) {
      this(prior, null, Utils.append(prior.errs, err), Utils.append(prior.cms, cm), null, null, null, validAUC);
    }
