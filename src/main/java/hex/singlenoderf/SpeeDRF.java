...
//  }
  ...
  private void validateInputData(){
    ...
    if (0.0f > drfParams._sample || drfParams._sample > 1.0f)
      throw new IllegalArgumentException("Sampling rate must be in [0,1] but found "+ drfParams._sample);
    if (drfParams._numSplitFeatures!=-1 && (drfParams._numSplitFeatures< 1 || drfParams._numSplitFeatures>vecs.length-1))
    ...
    if (drfParams._useNonLocalData && !canLoadAll( source, cai ))
