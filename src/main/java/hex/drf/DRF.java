...
public class DRF extends SharedTreeModelBuilder<DRF.DRFModel> {
  ...
  public static class DRFModel extends DTree.TreeModel {
    ...
    private DRFModel(DRF params, DRFModel prior, double err, ConfusionMatrix cm, water.api.AUC validAUC) {
  ...
  @Override protected DRFModel makeModel( DRFModel model, double err, ConfusionMatrix cm, ConfusionMatrix[] auccms) {
    return new DRFModel(this, model, err, cm, new water.api.AUC(auccms, ModelUtils.DEFAULT_THRESHOLDS) );
  }
