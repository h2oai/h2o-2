...
public class NeuralNetIrisTest {
  ...
  public static class TrainInput extends FrameInput {
    public TrainInput(Frame frame) {
      super(frame);
    }
  }

  public static class TestInput extends FrameInput {
    public TestInput(Frame frame) {
      super(frame);
    }
  }
...
//      _ls[i]._forward.get(_ls[i]._w);
    ...
    for( int n = 0; n < length; n++ ) {
      if( NeuralNetIrisTest.test(clones, n, error) )
        correct++;
    }
