...
//                          System.out.println("weight[" + o + "]=" + b);
                        ...
                        final double myTrainErr = mymodel.calcError(_train, trainPredict, "Final training error:", true, null, null, null);
                        final Frame testPredict = mymodel.score(_test, false);
                        final double myTestErr = mymodel.calcError(_test, testPredict, "Final testing error:",  true, null, null, null);
