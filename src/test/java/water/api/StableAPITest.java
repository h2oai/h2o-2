...
public class StableAPITest {
  ...
  static public void registerPyAPI() {
    ...
    regPy(GLM.class, "alpha", "beta_epsilon", "case", "case_mode", "destination_key", "expert", "family", "key", "lambda", "link", "lsm_solver", "max_iter", "n_folds", "parallel", "pollTimeoutsecs", "standardize", "threshold", "thresholds", "tweedie_power", "weight", "x", "y", "Y");
    regPy(GLMGrid.class, "alpha", "beta_epsilon", "case", "case_mode", "destination_key", "family", "key", "lambda", "link", "max_iter", "n_folds", "parallel", "thresholds", "weight", "x", "y");
    ...
    regPy(Inspect2.class, "offset", "src_key", "view");
    regPy(JStack.class);
    regPy(Jobs.class);
    regPy(KMeans.class, "cols", "destination_key", "epsilon", "initialization", "k", "max_iter", "normalize", "seed", "source_key");
    ...
    regPy(PCA.class, "destination_key", "ignore", "key", "standardize", "tolerance");
    ...
    regPy(Plot.class);
    regPy(PostFile.class, "key");
    regPy(Predict.class, "data", "model", "predict");
    ...
    regPy(RF.class, "bin_limit", "class_weight", "class_weights", "clear_confusion_matrix", "csvPathname", "data_key", "depth", "exclusive_split_limit", "features", "ignore", "iterative_cm", "model_key", "no_confusion_matrix", "ntree", "out_of_bag_error_estimate", "parallel", "pollTimeoutsecs", "response_variable", "sample", "sampling_strategy", "seed", "stat_type", "strata_samples", "use_non_local_data");
                    //"bin_limit", "class_weight", "class_weights", "clear_confusion_matrix", "csvPathname", "data_key", "depth", "exclusive_split_limit", "features", "gini", "hex_key", "ignore", "iterative_cm", "model_key", "no_confusion_matrix", "ntree", "out_of_bag_error_estimate", "parallel", "pollTimeoutsecs", "response_variable", "sample", "sampling_strategy", "seed", "stat_type", "strata_samples", "stratify", "use_non_local_data"
    regPy(RFScore.class);
    ...
    regPy(SummaryPage.class, "doPrint", "key", "max_column_display");
