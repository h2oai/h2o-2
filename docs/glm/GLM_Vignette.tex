...
\underbar{http://s3.amazonaws.com/h2o-release/h2o/master/latest.html}. Open your R Console and run the following to install the latest H2O build in R:
...
\textbf{Example}
To change the link function from the default inverse function to the log link function modify the \textt{link} argument.
