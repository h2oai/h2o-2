...
\item If you are a developer who wants to make changes to the R package before building and installing it, pull the source code from Git (\underbar{https://github.com/0xdata/h2o}) and follow the instructions in From Source Code (Github) at \underbar{http://docs.h2o.ai/developuser/quickstart\_git.html}.
...
{\texttt{sqrt}}: Computes the (principal) square root of x, {\sqrt{x}}.\\$\textrm
...
{\texttt{log1p}}: Compute log(1+x) accurately also for \textvert{$|x|$}\textvert{}\textless{}\textless{} 1.\\
...
{\texttt{expm1}}: Compute exp(x) - 1 accurately also for \textvert{$|x|$}\textvert{}\textless{}\textless{} 1.\\ 
...
{\texttt{gamma}}: Display the gamma function {\gamma{$(x)$}} \\  $\textrm
