 ...
 * Modified by @tkopczuk - Tomek Kopczuk tomek@bladepolska.com
 * 
 *
 * 
 * 
  ...
  $.widget("jb.dragtable", {
		...
		_create: function() {
			...
			el.delegate(o.items, 'mousedown.' + self.widgetEventPrefix, function(e){
				...
				var $handle = $(this),
					elementOffsetTop = self.element.position().top + o.topOffset;
				...
				if (e.button !== 0)
					return false;
				if ($(e.currentTarget).hasClass(o.noDragClass))
					return false;
