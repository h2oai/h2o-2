...
(jde-set-variables
 ...
 '(jde-run-option-application-args (quote ("-mainClass" "org.junit.runner.JUnitCore" "hex.gbm.GBMTest" "water.fvec.FVecTestX" "water.fvec.ParserTest2X" "water.fvec.NewVectorTestX")))
