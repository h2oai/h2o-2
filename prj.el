...
(jde-set-variables
 ...
 '(jde-run-option-application-args (quote ("-beta" "-mainClass" "org.junit.runner.JUnitCore" "hex.gbm.GBMTestX" "water.fvec.FVecTest" "water.fvec.ParserTest2X" "water.fvec.NewVectorTestX")))
