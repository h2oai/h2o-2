...
(jde-set-variables
 ...
 '(jde-run-option-application-args (quote ("-mainClass" "org.junit.runner.JUnitCore" "hex.gbm.GBMTestX" "water.fvec.FVecTestX" "water.fvec.ParserTest2" "water.fvec.NewVectorTestX")))
