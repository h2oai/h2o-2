...
(jde-set-variables
 ...
 '(jde-run-option-application-args (quote ("-mainClassX" "org.junit.runner.JUnitCore" "water.fvec.NewVectorTest" "water.parser.ParserTest" "water.parser.DatasetCornerCasesTest" "water.fvec.FVecTest")))
