...
(jde-set-variables
 ...
 '(jde-run-option-application-args (quote ("-mainClass" "org.junit.runner.JUnitCore" "water.fvec.NewVectorTestX" "water.fvec.NATestX" "water.fvec.FVecTestX" "hex.GBMTestX" "water.MRThrow")))
