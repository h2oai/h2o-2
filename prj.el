...
(jde-set-variables
 ...
 '(jde-run-option-application-args (quote ("-beta" "-mainClass" "org.junit.runner.JUnitCore" "hex.gbm.GBMTestX" "water.fvec.FVecTestX" "water.JStackTest" "water.fvec.ParserTest2X" "water.fvec.NewVectorTestX")))
