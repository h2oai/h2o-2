...
(jde-set-variables
 ...
 '(jde-run-option-application-args (quote ("-mainClass" "org.junit.runner.JUnitCore" "hex.gbm.GBMTest" "water.fvec.FVecTest" "water.fvec.ParserTest2" "water.fvec.NewVectorTest")))
