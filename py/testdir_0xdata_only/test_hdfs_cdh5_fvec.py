...
class Basic(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        if (localhost):
            h2o.build_cloud(1, use_hdfs=True, hdfs_version='cdh5', hdfs_name_node='192.168.1.180')
        else:
            h2o_hosts.build_cloud_with_hosts(1, use_hdfs=True, hdfs_version='cdh5', hdfs_name_node='192.168.1.180')
