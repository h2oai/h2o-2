...
def glm_score(self, csvFilename, bucket, csvPathname, modelKey, timeoutSecs=30, pollTimeoutSecs=30):
...
class Basic(unittest.TestCase):
    ...
    def test_GLM2_score_same(self):
        ...
        glm_score(self,filename2x, bucket, pathname2x, modelKey, timeoutSecs=60, pollTimeoutSecs=60)
        ...
        for i in range(3):
            ...
            glm_score(self,filename4x, bucket, pathname4x, modelKey, timeoutSecs=60, pollTimeoutSecs=60)
