...
initList = [
        ('Result0.hex', 'Result0.hex=c(1.3,0,1,2,3,4,5)'),
        ('Result1.hex', 'Result1.hex=c(2.3,0,1,2,3,4,5)'),
...
class Basic(unittest.TestCase):
    ...
    def test_exec_operators(self):
        ...
        start = time.time()
        h2e.exec_expr_list_rand(len(h2o.nodes), exprList, 'Result0.hex', maxTrials=200, timeoutSecs=10)
