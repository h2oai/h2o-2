...
class Basic(unittest.TestCase):
    ...
    def test_A_randomdata2(self):
        ...
        h2o_cmd.runRFOnly(parseResult=parseResult, trees=1, response_variable=2, timeoutSecs=20, csvPathname=csvPathname)
    ...
    def test_B_randomdata2_1_lineend(self):
        ...
        h2o_cmd.runRFOnly(parseResult=parseResult, trees=1, response_variable=2, timeoutSecs=20, csvPathname=csvPathname2)
