...
class Basic(unittest.TestCase):
    ...
    def test_parse_summary_airline_s3(self):
        ...
        (importHDFSResult, importPattern) = h2i.import_only(bucket='h2o-airlines-unpacked', path='*', schema='s3')
        ...
        for (csvFilename, timeoutSecs) in csvFilelist:
            ...
            parseResult = h2i.import_parse(bucket='home-0xdiag-datasets', path=csvPathname, schema='s3', hex_key=hex_key,
