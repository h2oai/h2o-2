...
class TestExcel(unittest.TestCase):
    ...
    def test_iris_xls(self):
        ...
        h2o_cmd.runRF(parseResult=parseResult, trees=100, timeoutSecs=5)
    ...
    def test_poker_xls(self):
        ...
        h2o_cmd.runRF(parseResult=parseResult, trees=100, timeoutSecs=10)
    ...
    def test_poker_xlsx(self):
        ...
        h2o_cmd.runRF(None, parseResult=parseResult, trees=100, timeoutSecs=120)
