...
CDH5_YARN_JOBTRACKER=172.16.2.217:8032

CDH5_YARN_NODES=2
CDH5_YARN_HEAP=16g

CDH5_YARN_JAR=h2odriver_cdh5.jar
NAME_NODE=172.16.2.216
H2O_JAR=h2o.jar
...
# CDH5_YARN_JAR_USED=$H2O_DOWNLOADED/hadoop/$CDH5_YARN_JAR
# CDH5_YARN_JAR_USED=$H2O_DOWNLOADED/$CDH5_YARN_JAR
H2O_JAR_USED=$H2O_BUILT/$H2O_JAR
CDH5_YARN_JAR_USED=$H2O_BUILT/hadoop/$CDH5_YARN_JAR

HDFS_OUTPUT=hdfsOutputDirName

REMOTE_HOME=/home/0xcustomer
REMOTE_IP=172.16.2.217
...
$REMOTE_SCP $CDH5_YARN_JAR_USED $REMOTE_USER:$REMOTE_HOME
...
../find_cloud.py -f h2o_one_node -hdfs_version hdp2.1 -hdfs_name_node $NAME_NODE -expected_size $CDH5_YARN_NODES
...
### for mr in 211 212 213 214 215 216 217 218 219 220
### do
...
./kill_0xcustomer_hadoop_jobs_on_113.sh 
