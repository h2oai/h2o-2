...
class Basic(unittest.TestCase):
    ...
    def test_RF_1000trees(self):
        ...
        start = time.time()
        rf_train = h2o_cmd.runRFOnly(parseResult=parseResult, ntree=100, timeoutSecs=14800, bin_limit=20000, out_of_bag_error_estimate=1,stat_type='ENTROPY',depth=100,exclusive_split_limit=0)
