from h2oPerf.H2O import *
from h2oPerf.Process import *
...
class PerfRunner:
    ...
    def __init__(self, test_root_dir, output_dir, nodes_in_cloud,
                 xmx, use_cloud = False, use_ip = "", use_port = "", base_port):
    """
    Create runner.
