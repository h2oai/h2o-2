...
test.glm2glmnetreg4.golden <- function(H2Oserver) {
...
fitH2O<- h2o.glm.FV(x=c("Height", "Volume"), y="Girth", family="gaussian", nfolds=0, alpha=.7, lambda=.15, data=treesH2O)
...
doTest("GLM Test: Regularization: Alpha=.7, verif with penalized", test.glm2glmnetreg4.golden)
