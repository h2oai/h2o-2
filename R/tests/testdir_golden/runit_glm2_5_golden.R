...
#Build matching models in R and H2O - Vanilla linear model 
...
fitH2O<- h2o.glm.FV(x=c("Age", "Ed", "Wantsmore"), y="Percentuse", family="gaussian", lambda=0, alpha=0, nfolds=0, data=cuseH2O)
fitR<- glm(Percentuse ~ Age + Ed + Wantsmore, family=gaussian, data=cuseR)
