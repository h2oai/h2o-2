...
trainH<- h2o.uploadFile(H2Oserver, locate("../smalldata/handmade.csv"))
...
h1<- h2o.glm.FV(x=c("a", "b", "c", "d", "e"), y="f", family="gaussian", alpha=0, lambda= mult1, nfolds=0, standardize=F, data=trainH)
...
h2<- h2o.glm.FV(x=c("a", "b", "c", "d", "e"), y="f", family="gaussian", alpha=0, lambda= mult2, nfolds=0, standardize=F, data=trainH)
...
h3<- h2o.glm.FV(x=c("a", "b", "c", "d", "e"), y="f", family="gaussian", alpha=0, lambda= mult3, nfolds=0, standardize=F, data=trainH)
...
h5<- h2o.glm.FV(x=c("a", "b", "c", "d", "e"), y="f", family="gaussian", alpha=0, lambda= mult5, nfolds=0, standardize=F, data=trainH)
...
h6<- h2o.glm.FV(x=c("a", "b", "c", "d", "e"), y="f", family="gaussian", alpha=0, lambda= mult6, nfolds=0, standardize=F, data=trainH)
...
h7<- h2o.glm.FV(x=c("a", "b", "c", "d", "e"), y="f", family="gaussian", alpha=0, lambda= mult7, nfolds=0, standardize=F, data=trainH)
...
h8<- h2o.glm.FV(x=c("a", "b", "c", "d", "e"), y="f", family="gaussian", alpha=0, lambda= mult8, nfolds=0, standardize=F, data=trainH)
...
h9<- h2o.glm.FV(x=c("a", "b", "c", "d", "e"), y="f", family="gaussian", alpha=0, lambda= mult9, nfolds=0, standardize=F, data=trainH)
...
h10<- h2o.glm.FV(x=c("a", "b", "c", "d", "e"), y="f", family="gaussian", alpha=0, lambda= mult10, nfolds=0, standardize=F, data=trainH)
...
h11<- h2o.glm.FV(x=c("a", "b", "c", "d", "e"), y="f", family="gaussian", alpha=0, lambda= mult11, nfolds=0, standardize=F, data=trainH)
...
h12<- h2o.glm.FV(x=c("a", "b", "c", "d", "e"), y="f", family="gaussian", alpha=0, lambda= mult12, nfolds=0, standardize=F, data=trainH)
