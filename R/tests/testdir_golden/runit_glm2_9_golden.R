...
#library(penalized) is a second means of independent verification for regularization, and is included here in case needed, but omitted from test because package isn't nec for test to run, and isn't part of runner
