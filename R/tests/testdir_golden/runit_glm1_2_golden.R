...
cuseH2O<- h2o.uploadFile.VA(H2Oserver, locate("../../smalldata/cuseexpanded.csv"), key="cuseH2O")
...
fitH2O<- h2o.glm(y="UsingBinom", x=c("AgeA","AgeC","AgeD","LowEd","MoreYes"), standardize=F,data=cuseH2O, family="binomial", lambda=0, alpha=0, nfolds=0)
