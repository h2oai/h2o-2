...
test <- function(conn) {
	print("Reading in data (tiny airline with UUIDs).")
		...
		print("Head of airline data: ") ; head(airline.hex)

	print("Take subset of rows where UUID is present.")
		airline.uuid = airline.hex[!is.na(airline.hex$uuid),]
		print("Dimension of new set: ") ; dim(airline.uuid)
		print("Head of new set: ") ; head(airline.uuid)
	...
	print("Take a random uniform test train split (30:70).")
		...
		print("Dimension of training set: ") ; dim(airline.train.hex)
		print("Dimension of test set: ") ; dim(airline.test.hex)
		print("Head of training set: ") ; head(airline.train.hex)
		print("Head of test set: ") ; head(airline.test.hex)
