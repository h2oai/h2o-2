...
test.GBM.ecology <- function(conn) {
  ...
  print("=============================")
  ecology.hex <- h2o.uploadFile.FV(conn, locate("smalldata/gbm_test/ecology_model.csv", schema="put"))
  ...
  ecologyTest.hex <- h2o.uploadFile.FV(conn, locate("smalldata/gbm_test/ecology_eval.csv"))
