...
test.GBM.SWpreds <- function(conn) {
  ...
  Log.info("H2O GBM (Naive Split) with parameters:\nclassification = TRUE, n.trees = 50, interaction.depth = 20, n.bins = 500\n")
  drfmodel.nogrp <- h2o.gbm(x = "X1", y = "y", data = swpreds.hex, n.trees = 50, interaction.depth = 20, n.bins = 500, group_split = FALSE)
  print(drfmodel.nogrp)
  
  Log.info("H2O GBM (Group Split) with parameters:\nclassification = TRUE, n.trees = 50, interaction.depth = 20, n.bins = 500\n")
  drfmodel.grpsplit <- h2o.gbm(x = "X1", y = "y", data = swpreds.hex, n.trees = 50, interaction.depth = 20, n.bins = 500, group_split = TRUE)
  ...
  Log.info("H2O GBM (Naive Split) with parameters:\nclassification = TRUE, n.trees = 50, interaction.depth = 20, n.bins = 500\n")
  drfmodel.nogrp2 <- h2o.gbm(x = c("X1", "X2"), y = "y", data = swpreds.hex, n.trees = 50, interaction.depth = 20, n.bins = 500, group_split = FALSE)
  print(drfmodel.nogrp2)
  
  Log.info("H2O GBM (Group Split) with parameters:\nclassification = TRUE, n.trees = 50, interaction.depth = 20, n.bins = 500\n")
  drfmodel.grpsplit2 <- h2o.gbm(x = c("X1", "X2"), y = "y", data = swpreds.hex, n.trees = 50, interaction.depth = 20, n.bins = 500, group_split = TRUE)
