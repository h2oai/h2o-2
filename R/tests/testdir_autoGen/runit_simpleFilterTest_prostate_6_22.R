            ...
            Log.info("======================== Begin Test ===========================")
            simpleFilterTest_prostate_6_22 <- function(conn) {
            ...
            tryCatch(test_that("simpleFilterTest_ on data prostate_6", simpleFilterTest_prostate_6_22(conn)), warning = function(w) WARN(w), error = function(e) FAIL(e))
