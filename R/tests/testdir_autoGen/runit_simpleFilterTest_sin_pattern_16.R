            ...
            Log.info("======================== Begin Test ===========================")
            simpleFilterTest_sin_pattern_16 <- function(conn) {
            ...
            tryCatch(test_that("simpleFilterTest_ on data sin_pattern", simpleFilterTest_sin_pattern_16(conn)), warning = function(w) WARN(w), error = function(e) FAIL(e))
