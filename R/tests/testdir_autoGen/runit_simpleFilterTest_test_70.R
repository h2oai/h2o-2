            ...
            Log.info("======================== Begin Test ===========================")
            simpleFilterTest_test_70 <- function(conn) {
            ...
            tryCatch(test_that("simpleFilterTest_ on data test", simpleFilterTest_test_70(conn)), warning = function(w) WARN(w), error = function(e) FAIL(e))
            PASS()
