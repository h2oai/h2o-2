            ...
            Log.info("======================== Begin Test ===========================")
            simpleFilterTest_40k_categoricals_33 <- function(conn) {
            ...
            tryCatch(test_that("simpleFilterTest_ on data 40k_categoricals", simpleFilterTest_40k_categoricals_33(conn)), warning = function(w) WARN(w), error = function(e) FAIL(e))
