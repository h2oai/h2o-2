...
test.basic.colname.assignment <- function(conn) {
  ...
  hex <- h2o.uploadFile.FV(conn, locate("smalldata/iris/iris.csv"), "iris.hex")
  hex_name <- h2o.uploadFile.FV(conn, locate("smalldata/iris/iris_header.csv"), "iris_header.hex")
