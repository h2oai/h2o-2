...
prostate.hex = h2o.uploadFile(remoteH2O, system.file("extdata", "prostate.csv", package="h2oRClient"), "prostate.hex")
...
iris.hex = h2o.uploadFile(remoteH2O, system.file("extdata", "iris.csv", package="h2oRClient"), "iris.hex")
summary(iris.hex)
