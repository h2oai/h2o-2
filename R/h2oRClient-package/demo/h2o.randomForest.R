...
iris.hex = h2o.importFile(localH2O, path = system.file("extdata", "iris.csv", package="h2oRClient"), key = "iris.hex")
summary(iris.hex)
...
covtype.hex = h2o.importFile(localH2O, path = system.file("extdata", "covtype.csv", package="h2oRClient"), key = "covtype.hex")
summary(covtype.hex)
