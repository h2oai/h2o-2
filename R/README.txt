...
Which returns the following output:
  ...
  ** preparing package for lazy loading
  Creating a generic function for ÔcolnamesÕ from package ÔbaseÕ in package h2o
  ...
  Creating a generic function for as.data.frame from package ÔbaseÕ in package h2o
  ** help
